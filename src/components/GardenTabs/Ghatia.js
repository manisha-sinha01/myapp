...
export default class Ghatia extends Component {
  constructor(props){
    ...
    this.state = {
      ...
      url : 'https://runga.rungamatteegroup.com/api/resource/Tea Invoice?fields=["invpr","invsuf","grade","status","dop","kgs","mark","tea_brand","fineleaf","sold_rate","sale_date","customer"]&filters=[["Tea Invoice", "estatename", "=", "Ghatia Tea Estate"]]&limit_page_length='+this.page_length,
    }
  ...
  componentDidMount(){
    ...
    const url= 'https://runga.rungamatteegroup.com/api/resource/Tea Invoice?fields=["invpr","invsuf","grade","status","dop","kgs","mark","tea_brand","fineleaf","sold_rate","sale_date","customer"]&filters=[["Tea Invoice", "estatename", "=", "Ghatia Tea Estate"]]&limit_start=20';
    console.log(url);
    this.setState({
      url:url
    })
                                          ...
                                          <Icon name="menu" />
                                             <Button style={{ backgroundColor: '#34A34F' }}
                                              onPress={() => {this.props.navigation.navigate('FilteredForm',{
                                                queryString: '["Tea Invoice", "estatename", "=", "Ghatia Tea Estate"]'
                                              })}}>
